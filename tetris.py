...
def draw_text_middle(text, size, color, surface):
    ...
    surface.blit(label, (top_left_x + play_width / 2 - (label.get_width() / 2), top_left_x + play_height / 2 - (label.get_height() / 2)))
...
def main(win):
    ...
    while run:
        ...
        if check_lost(locked_positions):
            draw_text_middle('Você perdeu :(', 80, (255, 255, 255), win)
            pygame.display.update()
